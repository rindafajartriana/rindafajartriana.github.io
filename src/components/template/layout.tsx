          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <DropdownMenu
              ...
              links={[
                ...
                { to: "/asuransi-kendaraan", label: "Motor" },
              ]}
            />
            ...
            <DropdownMenu
              ...
              links={[
                { to: "/asuransi-properti", label: "Rumah" },
                { to: "/asuransi-properti", label: "Apartemen" },
              ]}
            />
            ...
            <DropdownMenu
              ...
              links={[
                { to: "/asuransi-kargo", label: "Pengiriman Domestik" },
                {
                  to: "/asuransi-kargo",
                  label: "Pengiriman Internasional",
                },
                { to: "/asuransi-kargo", label: "Kargo Laut" },
                { to: "/asuransi-kargo", label: "Kargo Udara" },
                {
                  to: "/asuransi-kargo",
