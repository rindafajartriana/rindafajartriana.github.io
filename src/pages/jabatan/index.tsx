...
import { useDeleteJabatanMutation, useGetListJabatanQuery } from "@store/redux-collection/master-data"
...
const Jabatan = () => {
  ...
  const onForm = (editData?:AnyObj) => {
    dispatch(setPopup({
      title: `${editData ? "Ubah" : "Tambah"} Data Jabatan`,
      containerClass: "md:w-[30rem]",
      content: () => <FormJabatan editData={editData} onSuccess={() => refetch()} />,
      noButton: true
    }))
  }
